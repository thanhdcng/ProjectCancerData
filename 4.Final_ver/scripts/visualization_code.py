...
''' Define the directory to save extracted visualization data after the User so for this
 case  if your absolute path was like this C:/Users/Black/Desktop/internship/ProjectCancerData/4.Final_ver/data
  it will be ~/Desktop/internship/ProjectCancerData/4.Final_ver/data '''
VIS_DATA_DIR = os.path.join(os.path.expanduser("~/Desktop/internship/ProjectCancerData/4.Final_ver/data"), "extracted_visualization_data")
